...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* fn1/HHKB
     * ,-----------------------------------------------------------.
     * | ` | F1| F2| F3| F4|F5|F6|Mute|VolD|VolU|Play|Prev|Next|Del|
     * |-----------------------------------------------------------|
     * |Caps |   |   |   |   |   |   |   |Psc|Slk|Pus|Up |   |     |
     * |-----------------------------------------------------------|
     ...
     */ 
    [2] = KEYMAP_AEK( \
        GRV, NO,  NO,  NO,  NO,  NO,  NO, MUTE, VOLD, VOLU, MPLY, MPRV, MNXT, DEL, \
    ...
    [3] = KEYMAP_AEK( \
        ...
        LCTL,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN, QUOT,ENT, \
        LSFT,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH, RSFT, \
        LCTL,LGUI,LALT,          SPC,                          RALT,FN0, FN2),
};
...
const action_t PROGMEM fn_actions[] = {
    [0] = ACTION_LAYER_MOMENTARY(1),                  // Alt layer
    [1] = ACTION_LAYER_MOMENTARY(2),                  // HHKB layer
    [2] = ACTION_LAYER_TOGGLE(3),                     // Standard layer
};
