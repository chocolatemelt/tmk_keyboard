...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = KEYMAP_AEK( \
        ...
        TRNS,LALT,LGUI,          SPC,                          RGUI,FN0, FN1),
    ...
    [3] = KEYMAP_AEK( \
        ...
        LCTL,LGUI,LALT,          FN3,                         RALT,TRNS,FN2),
    ...
    [4] = KEYMAP_AEK( \
        ...
        LCTL,LGUI,LALT,          FN3,                         RALT,FN2,TRNS),
};
...
const action_t PROGMEM fn_actions[] = {
    [0] = ACTION_LAYER_MOMENTARY(3),                  // Alt layer
    [1] = ACTION_LAYER_MOMENTARY(4),                  // HHKB layer
    [2] = ACTION_LAYER_TOGGLE(2),                     // Standard layer
    [3] = ACTION_LAYER_TOGGLE(1),                     // OSX layer
};
